		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li><a href="/quizzme/dashboard"><span class="glyphicon glyphicon-stats"></span>
							Dashboard</a></li>
				</ul>
				<ul class="nav nav-sidebar">
					...
					<li><a href="/quizzme/user/recommendations"><span
							...
							me</a></li>
					<li><a href="/quizzme/quiz/search"><span class="glyphicon glyphicon-pencil"></span>
							Comment on Quizzes</a></li>
				</ul>
				<ul class="nav nav-sidebar">
						...
						<c:forEach items="${quizList}" var="quizzes">
							<tr>
								...
								<td align="center"><a
									...
									class="btn btn-info" role="button">Attempt this Quiz</a>&nbsp;&nbsp;<a
									href="/quizzme/quizzes/comment/${quizzes.id}"
									class="btn btn-info" role="button">Comment</a>&nbsp;&nbsp;<a
									href="/quizzme/quizzes/recommend/${quizzes.id}"
									class="btn btn-info" role="button">Recommend</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
